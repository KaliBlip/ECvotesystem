...
<head>
    ...
    <title>Voting System Admin - Candidates</title>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='action-buttons'>
                                            <button class='btn-icon edit' data-id='".$row['canid']."' title='Edit'>
                                                <i class='fas fa-edit'></i>
                                            </button>
                                            <button class='btn-icon delete' data-id='".$row['canid']."' title='Delete'>
